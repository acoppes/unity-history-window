...
namespace Gemserk
{
    ...
    {
        // will consider drag if mouse moved while pressed more than 5 pixels
        private const float distanceToConsiderDrag = 10.0f;
        ...
        private void OnMouseMove(MouseMoveEvent evt)
        {
            ...
            if ((startPosition - evt.mousePosition).sqrMagnitude < distanceToConsiderDrag * distanceToConsiderDrag)
            {
                return;
            }
